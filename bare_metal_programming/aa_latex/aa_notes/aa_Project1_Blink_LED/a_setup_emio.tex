\section{Setting up EMIO to Allow Ps to Control the LEDs}
...
\begin{enumerate}
    ...
    \item Select MIO configuration, I/O Peripherals and at the open GPIO. Tick EMIO GPIO and in the box select 8.
