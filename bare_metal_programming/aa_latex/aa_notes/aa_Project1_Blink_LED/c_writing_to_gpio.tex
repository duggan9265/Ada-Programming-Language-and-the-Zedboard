...
Finally I give the .gpr file. Maybe it will be useful. I started my project without using Alire. To make it an alr project, I cd'd into the project directory in my terminal:
...
Once this is all done, I ran alr build to build the .exe file (which we don't use), aswell as the .o file.